               ...
               @csrf
                ...
                <fieldset>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select onchange="getDistrict(this.value)" data-placeholder="Choose.." class="select-search form-control" name="division_id" id="division_id">
                                <option value=""></option>
                        ...
                        <div class="col-md-3">
                            ...
                            <select onchange="getUpazila(this.value)" data-placeholder="Select Division First" class="select-search form-control" name="district_id" id="district_id">
                                <option value=""></option>
                            </select>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <label for="lga_id">Upazila: <span class="text-danger">*</span></label>
                            <select data-placeholder="Select District First" class="select-search form-control" name="upazila_id" id="upazila_id">
                                <option value=""></option>
                            </select>
                        </div>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select onchange="getClassSections(this.value)" data-placeholder="Choose..." name="my_class_id" id="my_class_id" class="select-search form-control">
                                    <option value=""></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="my_class_id">Phone Number: <span class="text-danger">*</span></label>
                                <input type="text" name="guardian_phone" placeholder="Phone Number" class="form-control" value="{{ old('guardian_phone') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                <label for="my_class_id">Alternate Phone Number:</label>
                                <input type="text" name="alternate_phone" placeholder="Alternate Phone Number" class="form-control" value="{{ old('alternate_phone') }}">
                            </div>
                        </div>
                    </div>
