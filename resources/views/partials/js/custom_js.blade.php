<script>
    ...
    function getDistrict(get_division){
        var url = '{{ route('get_division', [':id']) }}';
        url = url.replace(':id', get_division);
        var lga = $('#district_id');
    ...
    function getUpazila(get_upazila){
        console.log(get_upazila);

        var url = '{{ route('get_upazila', [':id']) }}';
        url = url.replace(':id', get_upazila);
        var upazila = $('#upazila_id');
