...
class SettingsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $data = [
            ...
            ['type' => 'system_title', 'description' => 'SSMS'],
            ['type' => 'system_name', 'description' => 'Smart School Management System'],
            ['type' => 'term_ends', 'description' => '7/10/2025'],
            ['type' => 'term_begins', 'description' => '7/10/2025'],
            ['type' => 'phone', 'description' => '01836716620'],
            ['type' => 'address', 'description' => '60/1 Kalabagan ,Mirpur RD, Dhaka-1209'],
            ['type' => 'system_email', 'description' => 'info@ssms.com'],
