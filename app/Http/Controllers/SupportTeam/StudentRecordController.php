   ...
   public function __construct(LocationRepo $loc, MyClassRepo $my_class, UserRepo $user, StudentRepo $student)
   {
    ...
    public function store(StudentRecordCreate $req)
    {
       ...
       /* $ct = ($ct == 'J') ? 'JSS' : $ct;
        ...
        $data['upazila_id'] = $req->upazila_id;
        ...
        $gi['student_id'] = $student->id;
        $gi['father_name'] = $req->father_name;
        $gi['mother_name'] = $req->mother_name;
        $gi['phone'] = $req->guardian_phone;
        $gi['alternate_phone'] = $req->alternate_phone;
        GuardianInfo::create($gi);

        $father = $req->father_name;
        $father = explode(' ', $father);
        $father = $father[0];
        $father = strtolower($father);
        $fatherEmail = $father.'@'.'ssms.com';
        $gu['name'] = ucwords($req->father_name);
        $gu['username'] = $father;
        $gu['email'] = $fatherEmail;
        $gu['phone'] = $req->guardian_phone;
        $gu['password'] = Hash::make('ssms');
        $gu['user_type'] = 'parent';
        $gu['photo'] = Qs::getDefaultUserImage();
        $gu['code'] = strtoupper(Str::random(10));
